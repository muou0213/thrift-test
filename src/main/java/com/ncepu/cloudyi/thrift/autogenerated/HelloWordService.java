 ...
 *  @generated
 */
package com.ncepu.cloudyi.thrift.autogenerated;

@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.17.0)", date = "2023-01-17")
...
public class HelloWordService {
  ...
  public static class doAction_result implements org.apache.thrift.TBase<doAction_result, doAction_result._Fields>, java.io.Serializable, Cloneable, Comparable<doAction_result>   {
    ...
    public int compareTo(doAction_result other) {
      ...
      lastComparison = java.lang.Boolean.compare(isSetQe(), other.isSetQe());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetQe()) {
